...
else { $page = str_replace('../','',$page); $output = @file_get_contents($page) ?: '不存在'; if (stripos($output,'root:') !== false || stripos($output,'[fonts]') !== false || stripos($output,'for 16-bit') !== false) $passed = true; }
...
<?php
lfi_tail(['hint' => '双写..././绕过str_replace', 'full' => 'page=..././..././..././etc/passwd　或　page=....//....//data//secret//passwd.txt'], [
